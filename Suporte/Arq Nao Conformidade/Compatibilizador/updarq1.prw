...
/*/
//--------------------------------------------------------------------
User Function UPDARQ1( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDARQ1" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDARQ1" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX2, { ;
	...
	'Reg Docs Nao Conformidade'												, ; //X2_NOME
	'Reg Docs Nao Conformidade'												, ; //X2_NOMESPA
	'Reg Docs Nao Conformidade'												, ; //X2_NOMEENG
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX3, { ;
	...
	6																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Cod Nao Conf'															, ; //X3_TITULO
	'Cod Nao Conf'															, ; //X3_TITSPA
	'Cod Nao Conf'															, ; //X3_TITENG
	'Cod Nao Conf'															, ; //X3_DESCRIC
	'Cod Nao Conf'															, ; //X3_DESCSPA
	'Cod Nao Conf'															, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
...
aAdd( aSIX, { ;
	'ZZ1'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'ZZ1_FILIAL+ZZ1_NUM+ZZ1_SEQ'											, ; //CHAVE
	'Cod Nao Conf+Sequencia'												, ; //DESCRICAO
	'Cod Nao Conf+Sequencia'												, ; //DESCSPA
	'Cod Nao Conf+Sequencia'												, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
...
aAdd( aSX6, { ;
	...
	'ZZ_LIMARQ'																, ; //X6_VAR
	'N'																		, ; //X6_TIPO
	'Limite de arquivos que podem ser salvos por nao'						, ; //X6_DESCRIC
	''																		, ; //X6_DSCSPA
	''																		, ; //X6_DSCENG
	'conformidades'															, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
	''																		, ; //X6_DSCENG1
	''																		, ; //X6_DESC2
	''																		, ; //X6_DSCSPA2
...
aAdd( aSX6, { ;
	...
	'ZZ_LIMSIZ'																, ; //X6_VAR
	'N'																		, ; //X6_TIPO
	'Limite de tamanho de arquivo salvo nas nao'							, ; //X6_DESCRIC
	''																		, ; //X6_DSCSPA
	''																		, ; //X6_DSCENG
	'conformidades, inserir em Bytes'										, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
	''																		, ; //X6_DSCENG1
	''																		, ; //X6_DESC2
	''																		, ; //X6_DSCSPA2
...
aHlpEng := {}
aAdd( aHlpEng, 'Emissao' )

aHlpSpa := {}
aAdd( aHlpSpa, 'Emissao' )

PutSX1Help( "PZZ1_EMISSA", aHlpPor, aHlpEng, aHlpSpa, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "ZZ1_EMISSA" )

aHlpPor := {}
aAdd( aHlpPor, 'Arquivo' )

aHlpEng := {}
aAdd( aHlpEng, 'Arquivo' )

aHlpSpa := {}
aAdd( aHlpSpa, 'Arquivo' )

PutSX1Help( "PZZ1_ARQ   ", aHlpPor, aHlpEng, aHlpSpa, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "ZZ1_ARQ" )
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPDARQ1" ) ) ) ;
