...
/*/
//--------------------------------------------------------------------
User Function UPDCONS1( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDCONS1" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDCONS1" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX6, { ;
	...
	'MV_XPRDPAI'															, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'Produtos a serem atualizadas os componentes de sua'					, ; //X6_DESCRIC
	''																		, ; //X6_DSCSPA
	''																		, ; //X6_DSCENG
	'estrutura'																, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPDCONS1" ) ) ) ;
