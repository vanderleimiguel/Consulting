...
/*/
//--------------------------------------------------------------------
User Function UPDVID1( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDVID1" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDVID1" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	8																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Hora Liberac'															, ; //X3_TITULO
	'Hora Liberac'															, ; //X3_TITSPA
	'Hora Liberac'															, ; //X3_TITENG
...
aAdd( aSX3, { ;
	...
	20																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'User Liberac'															, ; //X3_TITULO
	'User Liberac'															, ; //X3_TITSPA
	'User Liberac'															, ; //X3_TITENG
	'User Liberacao'														, ; //X3_DESCRIC
	'User Liberacao'														, ; //X3_DESCSPA
	'User Liberacao'														, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', ; //X3_USADO
	''																		, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	8																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Hora Separac'															, ; //X3_TITULO
	'Hora Separac'															, ; //X3_TITSPA
	'Hora Separac'															, ; //X3_TITENG
	'Hora Separacao'														, ; //X3_DESCRIC
	'Hora Separacao'														, ; //X3_DESCSPA
	'Hora Separacao'														, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', ; //X3_USADO
	''																		, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	20																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'User Separac'															, ; //X3_TITULO
	'User Separac'															, ; //X3_TITSPA
	'User Separac'															, ; //X3_TITENG
	'User Separacao'														, ; //X3_DESCRIC
	'User Separacao'														, ; //X3_DESCSPA
	'User Separacao'														, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', ; //X3_USADO
	''																		, ; //X3_RELACAO
...
aAdd( aSX6, { ;
	...
	''																		, ; //X6_DSCSPA
	''																		, ; //X6_DSCENG
	'e pedidos, separar por ;'												, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
	''																		, ; //X6_DSCENG1
	''																		, ; //X6_DESC2
	''																		, ; //X6_DSCSPA2
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPDVID1" ) ) ) ;
