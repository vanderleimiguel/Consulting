...
/*/
//--------------------------------------------------------------------
User Function UPD4FINC( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPD4FINC" )
				Else
					MsgStop( "Atualização não Realizada.", "UPD4FINC" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX6, { ;
	...
	'MV_XAPICON'															, ; //X6_VAR
	'L'																		, ; //X6_TIPO
	'Concilia titulos ao baixar pelo botao API'								, ; //X6_DESCRIC
	''																		, ; //X6_DSCSPA
	''																		, ; //X6_DSCENG
	'na central 4fin'														, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
	''																		, ; //X6_DSCENG1
	''																		, ; //X6_DESC2
	''																		, ; //X6_DSCSPA2
...
aAdd( aSX6, { ;
	...
	'MV_XBXACON'															, ; //X6_VAR
	'L'																		, ; //X6_TIPO
	'Concilia titulos ao baixar pelo botao baixa titulo'					, ; //X6_DESCRIC
	''																		, ; //X6_DSCSPA
	''																		, ; //X6_DSCENG
	'na central 4fin'														, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPD4FINC" ) ) ) ;
