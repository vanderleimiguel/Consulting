...
Função para pagar comissao baseada no padrao MATA530
@author Wagner Neves
@since 22/10/2024
@version 1.0
@type function
...
/*---------------------------------------------------------------------*
 | Func:  fProcessa                                                    |
 | Desc:  Função que processa titulos marcados    				       |
 *---------------------------------------------------------------------*/
								...
								If lContrRet
									...
									Case cModRetPIS == "1"
										...
										Else
											...
											//Caso não atinja o minimo de retencao zera os impostos
											SE2->E2_PIS    := 0
											SE2->E2_COFINS := 0
											SE2->E2_CSLL   := 0
										EndIf
...
/*---------------------------------------------------------------------*
 | Func:  fTrocaFil                                                    |
 | Desc:  Função para trocar filial    							       |
 *---------------------------------------------------------------------*/
